...
# 用户配置区（根据需求修改以下参数）
# --------------------------
input_file = r'数据清洗\ualberta_chinese_artifacts.csv'         # 输入文件名
output_file = r'ulberta_pure.csv'       # 输出文件名
...
new_column_order = ['ID', 'Title', 'url', 'images',
                    'Type', 'Period', 'Materials', 'Measurements', 'Artist', 'Description', 'Illusion', 'Credit Line']
